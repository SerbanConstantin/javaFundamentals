...
public class temafigurigeometrice {
    public static class Tema01 {    double parameter;
        String nume;
        /*
     ...
     1. Display the following in the console:
        ...
        4. Exit    Option:_    2. Read the option from the console and store the value in a variable.
     ...
     5. Create 2 methods
        ...
        Ex cerc neede raza, patrat needes latura and triughi needs latura in order to calculate the area and perimeter.
                6. Using the 2 methids from point 5 display the values to the user.    Please format the value using printf: only display 2 decimals. */    public static void main(String[] args) {        Scanner input = new Scanner(System.in);        System.out.println("1. Patrat \n2. Cerc\n3. Triunghi echilateral\n4.Exit\n\nOption: ");        int option = Integer.parseInt(input.nextLine());        while(option != 4) {
            switch (option) {
                case 1: {
