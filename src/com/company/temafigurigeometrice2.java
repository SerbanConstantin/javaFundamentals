...
public class temafigurigeometrice2 {
    public static class Tema {    public static void main(String[] args) {
        String opt = "";
        String param;
        ...
        do {
            ...
            System.out.println("4. Exit");            System.out.println("Option:");
            opt = in.nextLine();            switch (opt) {
                case "1":
                case "3":
            ...
            param = in.nextLine();            System.out.printf("%n Aria %.3f",  aria(opt, param));
            System.out.printf("%n Perimetru %.3f",  perimetru(opt, param));        } while (!"4".equalsIgnoreCase(opt));
